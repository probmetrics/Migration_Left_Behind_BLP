...
initval = [xt_init; xl_init; xm_init; 0; xf_init; blft; bw; bitr;
		   xq_init; xqj_init; zeros(length(xqj_init)); zeros(2); -2]
...
# @time locpr_serial!(mktshare, initval, Delta_init, lnW, lnP, XQJ_mig,
# 					XT, XL, XM,	XF, XQ, ZSHK, USHK, wgt, sgwgt, nind, nalt,
# 					nsim, dgvec)
# @time locpr_thread!(mktshare, initval, Delta_init, lnW, lnP, XQJ_mig,
# 					XT, XL, XM,	XF, XQ, ZSHK, USHK, wgt, sgwgt, nind, nalt,
# 					nsim, dgvec)
#
...
# 				   initval, lnW, lnP, XQJ_mig, XT, XL, XM, XF, XQ, ZSHK,
