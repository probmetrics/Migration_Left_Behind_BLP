...
function slii_est_iter(initpar, lnDataShare::AbstractMatrix{T}, Delta_init::AbstractMatrix{T},
					  YL::AbstractVector{T}, YM::AbstractVector{T}, lnW::AbstractVector{T},
					  lnP::AbstractVector{T}, lnQbar::AbstractVector{T}, XQJ_mig::AbstractMatrix{T},
					  ...
					  wgt::AbstractVector{T}, sgwgt::AbstractVector{T}, nind::Int, nalt::Int, nsim::Int,
					  dgvec::AbstractVector{Int}, dage9vec::AbstractVector{T};
					  lnqrsd::T = 0.5846, alpha::T = 0.12, xdim::Int = 1,
    ...
    while iter_conv > btolerance
		...
		llkv_old = llkv_new
		btmp = coefx_old[33:35]
		println("The $k", "th iteration, blf, bw, bitr = ", "$btmp\n")
