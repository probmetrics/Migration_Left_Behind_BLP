...
include("$WKDIR/msm_check/get_msm_moments_nfxp_rev2.jl")
# include("$WKDIR/msl/msl_llk_loop.jl")
# include("$WKDIR/utility_funs/squarem_helper_funs.jl")
include("$WKDIR/msm_check/blp_squarem_nfxp.jl")
# include("$WKDIR/msm_check/msm_est_nfxp.jl")
...
msm_opt = parm -> msm_obj(parm, data_mnts_all, dwt, alpha, lnW, lnP, XQJ_mig,
			  			  ...
			  			  Delta_init, dgvec, htvec, dage9vec, wgt, sgwgt, shtwgt,
			  			  swgt9, nind, nalt, nsim; xdim = 1)
